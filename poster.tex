...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.4\textwidth]{./figures/Total_Moist_Dry_Savanna_Xeric.pdf}\\
	\includegraphics[width=0.4\textwidth]{./figures/Redun_Moist_Dry_Savanna_Xeric.pdf}
